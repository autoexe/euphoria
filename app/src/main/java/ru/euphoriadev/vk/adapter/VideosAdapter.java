...
import ru.euphoriadev.vk.ChooseQualityActivity;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.ivImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // String uris = "https://cs634105.vk.me/u66748/videos/a1d5d0e895.720.mp4";
               // Intent intent = new Intent(VideosAdapter.this.getContext(), ExoPlayerActivity.class);
               // intent.putExtra(ExoPlayerActivity.URI_LIST_EXTRA, uris);
               // getContext().startActivity(intent);
                Intent intent = new Intent(VideosAdapter.this.mContext, ChooseQualityActivity.class);
