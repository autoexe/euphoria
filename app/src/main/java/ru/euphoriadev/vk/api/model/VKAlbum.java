...
public class VKAlbum implements Serializable {
    ...
    public static VKAlbum parseFromAttachment(JSONObject o) {
        VKAlbum a = new VKAlbum();
        a.title = Api.unescape(o.optString("title"));
        a.aid = Long.parseLong(o.optString("id"));
        a.owner_id = Long.parseLong(o.optString("owner_id"));
        return a;
    }
}