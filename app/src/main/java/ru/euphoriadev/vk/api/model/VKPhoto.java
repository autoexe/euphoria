...
public class VKPhoto implements Serializable {
    ...
    public String src_normal; //photo_75
    ...
    public static VKPhoto parse(JSONObject o) {
        ...
        p.src_normal = o.optString("photo_130");
        ...
        if (o.has("likes")) {
            JSONObject jlikes = o.optJSONObject("likes");
        ...
        if (o.has("tags")) {
            JSONObject jtags = o.optJSONObject("tags");
            p.tags_count = jtags.optInt("count");
        }
        if (o.has("can_comment")) p.can_comment = o.optInt("can_comment") == 1;
